...
const MissionSect = () => {    
    return ( 
        <section className="leftCorner -mt-40 bg-deepRed relative outline-red-700 py-36 -z-10 text-white">
            <div className=" grid p-6 md:px-0 md:grid-cols-2 gap-10 items-center max-w-4xl mx-auto">
                <div className=' skew-y-12 h-60 w-full relative'>
                ...
                <div className="pt-10">
                    ...
                    <a href="/" className="block py-4 font-semibold border-b-2">Upcoming Service, Programs & Events</a>
                    <a href="/" className="block py-4 font-semibold border-b-2">Special Annoucements</a>
                    <a href="/" className="block py-4 font-semibold border-b-2">Give Offerings</a>
